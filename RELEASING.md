...
9. Create a signed tag: `git tag -s v0.1.0 -m "Provenance•9 Evidence Viewer 0.1.0"`.
10. Push the commit and tag, then create a GitHub release containing the source archive, SBOM and SHA-256 checksums.
